...
const routes = [
  ...
  },
  {
    path     : '/MemoList',
    name     : 'MemoList',
    component: () => import('@/components/Memo&Image/MemoList'),
  },
  // Tutorial : Tutorial 화면 상세
  {
    path     : '/MemoDetail/:id',
    name     : 'MemoDetail',
    component: () => import('@/components/Memo&Image/MemoDetail'),
  },
  // AddTutorial : Tutorial 목록 추가 화면
  {
    path     : '/MemoAdd',
    name     : 'add',
    component: () => import('@/components/Memo&Image/MemoAdd'),
  },
  // UploadImage 목록 추가 화면
  {
    path     : '/upload',
    name     : 'upload',
    component: () => import('@/components/Memo&Image/UploadImage'),
  },
  {
    path     : '/customers',
    name     : 'customers',
